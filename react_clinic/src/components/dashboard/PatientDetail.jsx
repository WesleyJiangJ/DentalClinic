                        ...
                        <Dropdown radius="sm">
                            ...
                            <DropdownMenu aria-label="Actions">
                                ...
                                <DropdownItem
                                    ...
                                    onPress={async () => {
                                        await sweetAlert("¿Estás seguro?", `El paciente ${user.first_name} ${user.first_lastname} será dado de ${user.status === true ? "baja" : "alta"}`, "warning", "success", `El paciente ${user.first_name} ${user.first_lastname} fue dado de ${user.status === true ? "baja" : "alta"}`);
